...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden neural-grid">
      ...
      <div className="absolute top-40 right-20 w-6 h-6 bg-neural-cyan rounded-full float opacity-40" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-40 left-20 w-3 h-3 bg-neural-purple rounded-full float opacity-50" style={{ animationDelay: '4s' }}></div>
      <div className="absolute bottom-60 right-10 w-5 h-5 bg-neural-pink rounded-full float opacity-30" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="text-center">
          ...
          <div className="fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
              Transforming complex problems into intelligent solutions through cutting-edge 
              machine learning, deep learning, and artificial intelligence technologies.
            </p>
          </div>
          ...
          <div className="flex justify-center gap-6 mb-16 slide-in-right">
            <Button variant="ghost" size="lg" className="hover-scale glow-neural">
